...
export default interface WebdriverCommands {
     ...
     *
     */
    setTimeouts(implicit?: (number | null), pageLoad?: (number | null), script?: (number | null)): Promise<void>;
    /**
     * Webdriver Protocol Command
     *
     ...
     *
     */
    addCredential(authenticatorId: string, credentialId: string, isResidentCredential: boolean, rpId: string, privateKey: string, userHandle?: string, signCount?: (number | null), largeBlob?: string): Promise<void>;
    /**
     * Webdriver Protocol Command
     *
     ...
     *
     */
    setUserVerified(authenticatorId: string, isUserVerified: boolean): Promise<void>;
}
